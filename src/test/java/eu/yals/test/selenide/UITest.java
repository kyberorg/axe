...
import static eu.yals.test.utils.pages.FrontPage.MainRow.SUBMIT_BUTTON;
...
@Slf4j
public class UITest {
    private static final String REPORT_DIRECTORY = System.getProperty(Selenide.Props.REPORT_DIR, Selenide.Defaults.REPORT_DIR);
    ...
    protected final static String BASE_URL = System.getProperty(App.Properties.TEST_URL, LOCAL_URL);
    ...
    public static void tearDown() {
        ...
        log.info("Testing Finished. Goodbye!");
    }

    private static void debugInfo() {
        String debugInfo = App.NEW_LINE + "=== Debug Info ===" +
                App.NEW_LINE +
