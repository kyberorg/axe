...
import static eu.yals.test.utils.pages.FrontPage.MainRow.*;
import static eu.yals.test.utils.pages.FrontPage.OverallRow.*;
import static eu.yals.test.utils.pages.FrontPage.ResultRow.RESULT_DIV;
