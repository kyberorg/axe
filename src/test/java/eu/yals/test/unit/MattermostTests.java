...
public class MattermostTests {
    ...
    public void shouldBeValidObjectWithMissingFieldsWhenAreNotPresentIsBody() {
        ...
        Assert.assertEquals(Mattermost.Constants.NO_VALUE, mm.getChannelId());
        Assert.assertEquals(Mattermost.Constants.NO_VALUE, mm.getChannelName());
        Assert.assertEquals(Mattermost.Constants.NO_VALUE, mm.getCommand());
        Assert.assertEquals(Mattermost.Constants.NO_VALUE, mm.getTeamDomain());
        Assert.assertEquals(Mattermost.Constants.NO_VALUE, mm.getTeamId());
        assertTrue(mm.getText().contains(host));
        assertEquals(token, mm.getToken());
        assertEquals(userId, mm.getUserId());
        assertEquals(uzer, mm.getUsername());
