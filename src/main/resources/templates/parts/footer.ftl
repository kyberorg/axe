<table class="footer" cellpadding="0" cellspacing="0" width="100%" style="margin: 0; width: 100%;">
    ...
    <tr>
        <td class="content-block" style="box-sizing: border-box; line-height: 25px; margin: 0 0 10px;-webkit-font-smoothing: antialiased; padding: 10px 0 0 10px; -webkit-text-size-adjust: none; text-align: center;" valign="top">
            Axe.pm - Short Links for free. Created by <a href="https://github.com/kyberorg">Kyberorg</a>.
        </td>
    </tr>
</table>