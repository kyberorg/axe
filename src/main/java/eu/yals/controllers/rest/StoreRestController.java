...
public class StoreRestController {
    ...
    public Json store(@RequestBody String body, HttpServletResponse response) {
        ...
        if (!errors.isEmpty()) {
            ...
            Set<ConstraintViolation> errorsSet = new HashSet<>(errors);
            response.setStatus(421);
            return ErrorJson.createFromSetOfErrors(errorsSet);
        }
        ...
        if (result instanceof StoreResult.Success) {
            ...
            return ErrorJson.createWithMessage("Database is down");
        } else {
