...
public class LinkService {
     ...
     *
     * @return
     * {@link OperationResult#OK} when record exists,
    ...
    /**
     * Stores new link with autogenerated ident.
     *
     * @param link string with long link to store
     * @return {@link OperationResult} object with stored {@link Link} or error with message.
     */
    public OperationResult createLink(final String link) {
        return createLink(null, link);
    }

    /**
     * Stores new link with user-defined ident, but without providing Session ID (for non-UI requests).
     *
     * @param customIdent string with user-defined ident or {@code null} for autogenerated ident
     * @param link string with long link to store
     * @return same as {@link #createLink(String, String, String)}
     */
    public OperationResult createLink(final String customIdent, final String link) {
        return createLink(customIdent, link, null);
    }
     ...
     * @param customIdent string with user-defined ident or {@code null} for autogenerated ident
     * @param link string with long link to store
     * @param sessionId string with session ID or {@code null}.
     ...
     */
    public OperationResult createLink(final String customIdent, final String link, final String sessionId) {
        //Link validation
        OperationResult urlValidationResult = validateUrl(link);
        String urlToStore;
        ...
        String ident;
        if (customIdent != null) {
            OperationResult identValidationResult = validateIdent(customIdent);
        ...
        try {
            ...
            if (sessionId != null) {
                linkInfoService.createLinkInfo(ident, sessionId);
            } else {
